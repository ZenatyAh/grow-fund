...
const FormInput = ({ label, icon, className, containerClassName, ...props }: InputProps) => (
  <div className={cn("flex flex-col gap-[8px]", containerClassName)}>
    <label className="text-[16px] font-bold text-[#0F172A] text-right font-['var(--font-tajawal)'] leading-[150%]">
      {label}
    </label>
        ...
        onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex gap-[24px]">
            <div className="flex-1 flex flex-col gap-[8px]">
              <label className="text-[16px] font-bold text-[#0F172A] text-right font-['var(--font-tajawal)'] leading-[150%]">تاريخ الميلاد</label>
              <div className="relative w-full h-[56px] px-[16px] py-[12px] bg-white border border-[#E2E8F0] rounded-[12px] flex items-center gap-[8px] cursor-pointer">
                <input 
                  type="date"
            ...
            <div className="flex-1 flex flex-col gap-[8px]">
              <label className="text-[16px] font-bold text-[#0F172A] text-right font-['var(--font-tajawal)'] leading-[150%]">الجنس</label>
              <div className="relative w-full h-[56px] px-[16px] py-[12px] bg-white border border-[#E2E8F0] rounded-[12px] flex items-center gap-[8px] cursor-pointer">
          ...
          <div className="flex flex-col gap-[8px]">
            <label className="text-[16px] font-bold text-[#0F172A] text-right font-['var(--font-tajawal)'] leading-[150%]">رقم الهاتف</label>
            <div className="flex gap-[12px] items-end relative">
              ...
              <Button variant="primary" className="h-[56px] px-[24px] min-w-[117px]">تحقق</Button>
            </div>
          </div>
          ...
          {/* About Me */}
          <div className="flex flex-col gap-[8px]">
            <label className="text-[16px] font-bold text-[#0F172A] text-right font-['var(--font-tajawal)'] leading-[150%]">نبذة عني</label>
            <textarea 
              placeholder="اكتب نبذة مختصرة عنك وعن اهتماماتك"
              className="w-full h-[150px] px-[16px] py-[12px] bg-white border border-[#E2E8F0] rounded-[12px] text-[16px] text-[#334155] text-right focus:outline-none focus:border-[#2563EB] font-['var(--font-tajawal)'] resize-none"
            />
          </div>
